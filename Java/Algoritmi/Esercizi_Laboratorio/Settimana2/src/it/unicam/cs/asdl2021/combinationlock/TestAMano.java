...
/**
 * Testa le funzionalit√† delle classi relative alla cassaforte.
 * 
 * @author Luca Tesei
 *
 */
public class TestAMano {
    ...
    public static void main(String[] args) {
        ...
        if (c.isOpen())
            System.out.println("ERRORE: La cassaforte non si Ë chiusa correttamente!");
        else
            System.out.println("La cassaforte si Ë chiusa correttamente.");
        ...
        if (c.isOpen())
            System.out.println(
                    "ERRORE: La cassaforte si Ë aperta con la combinazione errata!");
        else
            System.out.println("La cassaforte Ë rimasta chiusa correttamente.");
        ...
        c.open();
        if (c.isOpen())
            System.out.println("La cassaforte si Ë aperta correttamente!");
        else
            System.out.println(
                    "ERRORE: La cassaforte Ë rimasta chiusa con la combinazione giusta!");
        System.out.println("Creo uno scassinatore...");
        Burglar f = new Burglar(c);
        System.out.println("Lo scassinatore dice che la combinazione √® "
                + f.findCombination());
