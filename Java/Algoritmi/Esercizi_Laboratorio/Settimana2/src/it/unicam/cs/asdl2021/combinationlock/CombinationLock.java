...
public class CombinationLock {
     ...
     * @throw IllegalArgumentException se la combinazione fornita non � una
     ...
     *                                      se il carattere fornito non � una
     ...
     */
    public void open() {
    	//se non � stato inserita una nuova stringa la cassaforte rimane chiusa indipendentemente dall'input dell'utente
    	if(!modified) {
    		isOpen = false;
    		return;
    	}
    ...
    /**
     * Determina se la cassaforte � aperta.
     * 
     * @return true se la cassaforte � attualmente aperta, false altrimenti
     */
     ...
     * cassaforte � attualmente aperta. Se la cassaforte � attualmente chiusa
    ...
    public void lockAndChangeCombination(String aCombination) {
	    ...
	    //se la cassaforte � chiusa non faccio nulla
    	if(!isOpen) return;
