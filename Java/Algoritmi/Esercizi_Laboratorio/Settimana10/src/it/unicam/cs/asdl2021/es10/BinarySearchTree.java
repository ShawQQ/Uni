...
public class BinarySearchTree<E extends Comparable<E>> {
    ...
    protected class RecBST {
        ...
        protected int computeHeight() {
            ...
            if(this.left != null){
                leftHeight = this.left.computeHeight();
            }
            if(this.right != null){
                rightHeight = this.right.computeHeight();
            }
        ...
        protected boolean insert(E label) {
            int compare = label.compareTo(this.label);

            boolean result = false;
            if(compare < 0){
                if(this.getLeft() == null){
                    this.setLeft(new RecBST(label, null, null, this));
                    return true;
                }else{
                    result = this.getLeft().insert(label);
                }
            }else if(compare > 0){
                if(this.getRight() == null){
                    this.setRight(new RecBST(label, null, null, this));
                    return true;
                }else{
                    result = this.getRight().insert(label);
                }
            }
        ...
        protected RecBST search(E label) {
            ...
            if(label.compareTo(this.label) > 0){
                if(this.getRight() == null){
                    ...
                    return this.getRight().search(label);
                }
            }else{
                if(this.getLeft() == null){
                    return null;
                }else{
                    return this.getLeft().search(label);
                }
            }
        }
